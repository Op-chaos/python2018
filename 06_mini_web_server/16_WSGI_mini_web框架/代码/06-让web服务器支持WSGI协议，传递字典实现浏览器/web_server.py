...
class WSGIServer(object):
    ...
    def service_client(self, new_socket):
        ...
        if not file_name.endswith(".py"):
			...
			# 相对上面注释具有解耦功能
            body = mini_frame.application(env, self.set_response_header)    # wsgi协议格式
    ...
    def set_response_header(self, status, headers):      # wsgi协议格式
        self.status = status
        self.headers = [("server", "mini_web v8.8")]     # 服务器版本在然在服务器里面写
